...
namespace eGym.Core.Domain.Migrations
{
    ...
    [Migration("20210211214031_anagFixRequired")]
    partial class anagFixRequired
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eGym.Core.Domain.Anag_Master", b =>
                {
                    ...
                    b.Property<string>("Ang_BusinessName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("eGym.Core.Domain.Todo_Master", b =>
                {
                    ...
                    b.Property<string>("TD_Content")
                        .HasColumnType("ntext");

                    b.Property<DateTime>("TD_CreationDate")
                        .HasColumnType("datetime");

                    b.Property<string>("TD_Deadline")
                        .IsRequired()
                        .HasColumnType("nvarchar(25)");

                    b.Property<DateTime?>("TD_DeadlineDate")
                        .HasColumnType("datetime");

                    b.Property<TimeSpan?>("TD_DeadlineTime")
                        .HasColumnType("time");

                    b.Property<bool>("TD_Important")
                        .HasColumnType("bit");

                    b.Property<string>("TD_Note")
                        .HasColumnType("nvarchar(MAX)");

                    b.Property<string>("TD_Priority")
                        .IsRequired()
                        .HasColumnType("nvarchar(10)");

                    b.Property<DateTime?>("TD_StatusDate")
                        .HasColumnType("datetime");

                    b.Property<short>("TD_StatusID")
                        .HasColumnType("smallint");

                    b.Property<string>("TD_Title")
                        .HasColumnType("nvarchar(250)");

                    b.HasKey("TD_ID");

                    b.ToTable("Todo_Master", "dbo");
                });
            ...
            modelBuilder.Entity("eGym.Core.Domain.Anag_Master", b =>
                {
                    b.HasOne("eGym.Core.Domain.Country", "BirthCountry")
                        .WithMany("Anag_MasterBirthCountries")
                        .HasForeignKey("Ang_BirthCountry")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("eGym.Core.Domain.Country", "Citizenship")
                        .WithMany("Anag_MasterCitizenships")
                        .HasForeignKey("Ang_Citizenship")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("eGym.Core.Domain.Country", b =>
                {
                    ...
                    b.Navigation("Anag_MasterBirthCountries");

                    b.Navigation("Anag_MasterCitizenships");
                });
