...
namespace eGym.Application.DTO
{
    ...
    public class TodoDTO
    {
        ...
        public DateTime TD_CreationDate { get; set; } = DateTime.Now;
        public int TD_Priority { get; set; } = (int)TodoPriorityEnum.Low;
        public bool TD_Important { get; set; }
        public int TD_Deadline { get; set; } = (int)TodoDeadlineEnum.WhenIsPossible;
        ...
        public short TD_StatusID { get; set; } = EN_TodoStatus.Scheduled.ID;
