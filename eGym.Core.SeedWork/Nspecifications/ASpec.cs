...
namespace eGym.Core.SeedWork.NSpecifications
{
    ...
    public abstract class ASpec<T> : ISpecification<T>
    {
        ...
        public sealed class And<T> : ASpec<T>, IOrSpecification<T>
        {
            ...
            public override Expression<Func<T, bool>> Expression { get { return Spec1.Expression.And(Spec2.Expression); } }
        ...
        public sealed class Or<T> : ASpec<T>, IOrSpecification<T>
        {
            ...
            public override Expression<Func<T, bool>> Expression { get { return Spec1.Expression.Or(Spec2.Expression); } }

            public new bool Is(T candidate) { return Spec1.IsSatisfiedBy(candidate) || Spec2.IsSatisfiedBy(candidate); }
        }
        ...
        public sealed class Not<T> : ASpec<T>, INotSpecification<T>
        {
            ...
            public override Expression<Func<T, bool>> Expression { get { return Inner.Expression.Not(); } }

            public new bool Is(T candidate) { return !Inner.IsSatisfiedBy(candidate); }
        }
    }
}